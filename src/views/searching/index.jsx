...
const Index = () => {
  ...
  const getDataSearch = () => {
    ...
    dispatch(getDataProductSearch(searching, handleSuccess));
  };
          ...
          <div className={Style.bg}>
            ...
            <div className="row d-flex justify-content-center">
              {dataSearch&& dataSearch.length === 0?(
                <h1 className="text-center" style={{paddingTop:'14%',paddingBottom:'14%'}}>Data Tidak Di temukan</h1>
              ):
              dataSearch &&
